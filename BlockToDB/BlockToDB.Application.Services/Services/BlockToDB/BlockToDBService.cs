...
using BlockToDB.Resources.Utils;
...
namespace BlockToDB.Application
{
    public class BlockToDBService : ServiceBase, IBlockToDBService
    {
        ...
        public int ConvertBlockToDB(string model, int type)
        {
            ...
            Code code = BlockToDBConverter.ToCode(content, codeLanguage);
        ...
        public CodeDTO DownloadFile(int id)
        {
            return CodeRepository.GetForDownload(id);
        }
